...
const NavBar = () => {
  return (
    <header className="header flex justify-between items-center px-10 py-5">
        ...
        {/* Social icons */}
        <nav className="flex gap-10 min-w-10">
            {/* linkedin */}
            <a href="https://www.linkedin.com/in/yilinnlee" target="_blank" rel="noopener noreferrer">
            ...
            {/* github */}
            <a href="https://github.com/yleeyilin" target="_blank" rel="noopener noreferrer">
            ...
            {/* mail */}
            <a href="mailto:leeyilin@u.nus.edu" target="_blank" rel="noopener noreferrer">
                <svg className="w-6 h-6 text-gray-800 dark:text-white " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
